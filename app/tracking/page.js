...
export default function TrackingPage() {
  ...
  useEffect(() => {
    load();
    const interval = setInterval(load, 8000); // refresh berkala
  ...
  return (
    <div>
      <p className="text-xs mb-4 text-muted">
        Pantau posisi motor yang sedang aktif disewa. Jika belum ada GPS tracker fisik terpasang, posisi yang ditampilkan adalah contoh/placeholder.
      </p>
